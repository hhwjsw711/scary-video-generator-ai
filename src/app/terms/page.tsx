...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-24 md:py-32">
      <h1 className="font-kecal text-2xl text-purple-300 md:text-[50px] md:leading-[50px]">
        Terms of Service
      </h1>
      <p className="mt-2 font-kecal text-sm text-purple-400">
        Effective date: 15 March 2026
      </p>
      <p className="mt-6 font-kecal leading-relaxed text-gray-300">
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 font-kecal leading-relaxed text-gray-300">

...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-950 px-6">
      <h1 className="font-kecal text-5xl text-purple-300 md:text-[80px]">
        404
      </h1>
      <h2 className="mt-4 font-kecal text-3xl text-purple-400 md:text-5xl">
        Page Not Found
      </h2>
      <p className="mt-4 font-kecal text-lg text-gray-400">

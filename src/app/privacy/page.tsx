...
export const metadata: Metadata = {
  title: "Privacy Policy — Wordream",
  description: "Privacy Policy for Wordream AI Video Generation Platform",
};

const PRIVACY_EMAIL = "privacy@wordream.com";
const SITE_URL = "https://wordream.com";
    ...
    <main className="mx-auto max-w-3xl px-6 py-24 md:py-32">
      ...
      <section className="mt-12">
        ...
        <p className="mt-4 font-special leading-relaxed text-gray-300">
          ...
          met (e.g., revenue, volume of consumers, or data sales). As Wordream
          grows, we are committed to complying with all applicable US state
          privacy requirements. This section describes the rights we will honour
          for US users.
        </p>
